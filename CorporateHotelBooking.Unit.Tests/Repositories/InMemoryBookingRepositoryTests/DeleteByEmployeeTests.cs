...
public class DeleteByEmployeeTests
{
    ...
    public void DeleteNoBookings()
    {
        // Arrange
        var bookingRepository = new InMemoryBookingRepository();
        bookingRepository.Add(new Booking(1, employeeId: 1, 1,RoomType.Standard,new DateOnly(2021, 1, 1), new DateOnly(2021, 1, 2)));
        bookingRepository.Add(new Booking(2, employeeId: 1, 1,RoomType.Standard,new DateOnly(2021, 1, 3), new DateOnly(2021, 1, 4)));
        bookingRepository.Add(new Booking(3, employeeId: 1, 1,RoomType.Standard,new DateOnly(2021, 1, 5), new DateOnly(2021, 1, 6)));

        // Act
        bookingRepository.DeleteByEmployee(employeeId: 2);

        // Assert
        bookingRepository.GetCount(1, RoomType.Standard, new DateOnly(2021, 1, 1), new DateOnly(2021, 1, 6)).Should().Be(3);
    }
}